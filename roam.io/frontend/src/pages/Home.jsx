    ...
    <div>
      ...
      >
        <div>
          ...
          <p class="lead mb-4">
            Get your flights, hotels, attractions, and maps tailored to your
            travel style.
          </p>
          <button
        ...
        <div class="row text-center mx-2">
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p class="text-muted">
                Find the best flight options for your travels.
              </p>
            </div>
          </div>
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p class="text-muted">
                Comfortable stays and hotels for your vibe.
              </p>
            </div>
          </div>
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p class="text-muted">
                Discover landmarks, restaurants, and hidden gems.
              </p>
            </div>
          </div>
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p class="text-muted">
                Visualize your journey with location pins and routes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row text-center mx-2">
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p>
                Tell us about your travel style, budget, and dream desinations.
              </p>
            </div>
          </div>
          <div class="col-3">
            <div class="card border-0 shadow p-4 h-100">
              ...
              <p>
                We will generate flights, lodging, and attraction
                recommendations.
              </p>
            </div>
          </div>
      ...
      <footer class="py-4 text-center bg-primary text-white">
        <div>
          <p class="mb-0">
            Copyright &copy; 2025 roam.io | All rights reserved
          </p>
